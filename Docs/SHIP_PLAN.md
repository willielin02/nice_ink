...
**與 SPEC 的落差（我不動 SPEC，留給 user 裁）**：
- SPEC #116 的開場動畫概念仍是舊案「力士們目送一位走出去的極道壯漢」；08-27 user 已
  改成「榻榻米喝酒看電視→電視上極道刺青→關電視→有人提議→開局」並已實作。
- SPEC 待定 #14「開場動畫場景改寫」仍列為未決，但場景實際上已經改寫並出貨。
